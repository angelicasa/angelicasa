...
- 📚 PUC Minas/ead - Sistemas para internet - 4º período.
- 📖 Conhecimentos em desenvolvimento web, plano de testes, cenários de testes, casos de testes, report de bugs, banco de dados, API test, SQL, Postman, Insomnia, Cypress. Estudando ferramentas de automação.
